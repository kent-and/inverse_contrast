...
\end{equation}
Here $dt$ is forward timestep and $\Delta t$ is the difference between observation time and forward time. \kam{This has to be made clearer. Earlier we used $u_{obs}$ for observation. Also this also only applies if $t_i$ is close to the observations, right?} 
