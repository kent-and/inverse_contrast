...
\author{Lars Magnus Valnes$\sp{1}$, Sebastian K. Mitusch$\sp{3}$, Geir Ringstad$\sp{2}$, \\ 
Per Kristian Eide$\sp{2}$, Simon W. Funke$\sp{3}$, Kent-Andre Mardal$\sp{1,3}$   }
\affil{ $\sp{1}$University of Oslo, Department of Mathematics \\ $\sp{2}$Oslo University Hospital, Rikshospitalet \\ $\sp{3}$Simula Research Laboratory}

%Lars M.Valnes 1
%Geir Ringstad 2 , Per K.Eide 2 , Sebastian Mitusch 3 ,
%Simon Funke 3 and Kent-Andre Mardal 1,3
%1
%University of Oslo
