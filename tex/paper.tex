...
The median diffusion coefficient in the DTI was estimated to be respectively in white and grey matter to be 8.7e-4 $\mathrm{mm\sp{2}/s}$ and  1.0e-3 $\mathrm{mm\sp{2}/s}$. %This corresponds to 3.1 $\mathrm{mm\sp{2}/h}$ and  3.6 $\mathrm{mm\sp{2}/h}$. 
The self-diffusivity of water have been estimated to be about  3.0e-3$\mathrm{mm\sp{2}/s}$ at 37\sp{o}C.% This corresponds to 10.8 $\mathrm{mm\sp{2}/h}$ and  $\mathrm{mm\sp{2}/h}$. 

This is an increase from the reported values in [insert citation] of XX and XX.  
