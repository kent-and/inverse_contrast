...
$\alpha$ & $\beta$ & k  & iter & $ D_{\Omega_1} = 1000$ & $ D_{\Omega_2} = 4.0 $ & $D_{\Omega_3} = 8.0 $ & wrong$g$ \\
\hline
 1.0e-05 	 & 1.0e-02 	 & 20 & 429 	 & +0.003 & +0.018 & +0.005 & +0.007 \\ 
 1.0e-06 	 & 1.0e+00 	 & 20 & 219 	 & -0.008 & +0.016 & +0.009 & +0.006 \\ 
 1.0e-06 	 & 1.0e-02 	 & 20 & 386 	 & +0.003 & +0.018 & +0.005 & +0.007 \\ 
\end{tabular}}
\label{Tab::2}
\end{table} 
...
$\alpha$ & $\beta$ & k  & iter & $ D_{\Omega_1} = 1000$ & $ D_{\Omega_2} = 4.0 $ & $D_{\Omega_3} = 8.0 $ & wrong$g$ \\
\hline
 1.0e-05 	 & 1.0e-03 	 & 40 & 210 	 & +0.019 & +0.005 & -0.001 & +0.002 \\ 
 1.0e-05 	 & 1.0e-01 	 & 40 & 597 	 & +0.006 & +0.015 & -0.008 & +0.017 \\ 
 1.0e-06 	 & 1.0e-02 	 & 40 & 910 	 & +0.046 & +0.047 & -0.020 & +0.065 \\ 
\end{tabular}}
\label{Tab::2}
\end{table} 
...
\section{Discussion}
 ...
 \begin{table}
\centering
\caption{ $\tau = [0.8, 1.0, 1.2, 1.8, 2.4, 3.6, 5.4, 7.6, 24.0] $}
\resizebox{\textwidth}{!}{\begin{tabular}{*{8}c}
$\alpha$ & $\beta$ & k & iter & $ D_{\Omega_1} = 1000$ & $ D_{\Omega_2} = 4.0 $ & $D_{\Omega_3} = 8.0 $ & $g$ \\
\hline
 1.0e-04 	 & 1.0e-02 	 & 40 & 283 	 & -0.059 & -0.020 & -0.027 & +0.331 \\ 
 \rowcolor{red} 1.0e-04 	 & 1.0e-03 	 & 40 & 247 	 & -0.062 & -0.023 & -0.030 & +0.407 \\ 
 1.0e-05 	 & 1.0e-02 	 & 40 & 400 	 & -0.059 & -0.020 & -0.027 & +0.260 \\ 
\rowcolor{red}  1.0e-05 	 & 1.0e-03 	 & 40 & 183 	 & -0.063 & -0.023 & -0.029 & +0.404 \\ 
...
\rowcolor{red}  1.0e-06 	 & 1.0e-03 	 & 40 & 234 	 & -0.062 & -0.023 & -0.030 & +0.398 \\ 
\end{tabular}}
