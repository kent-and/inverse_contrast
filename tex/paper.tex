...
known solution. The manufactured observations were obtained by forward computation of \eqref{Eq::PDE} with the Dirichlet boundary condition defined as \ficme{Dirichlet boundary $\Omega_1 }
\begin{equation}
