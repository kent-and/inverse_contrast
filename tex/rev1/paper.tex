...
The projection of values was implemented by taking the average of the adjacent CSF voxels to the boundary vertices on $\Omega_b$ and $\Omega_r$. We used the Gaussian smoothing found in the python-module scipy~\cite{jones2001scipy}, and applied the smoothing to the MRI-data. %The projection and smoothing approach changes the observations, while the gradient regularization adds additional term to the functional. Therefore a dual method can also be considered, 
